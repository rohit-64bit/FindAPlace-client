        ...
        <>
            <div className='h-screen flex flex-col justify-center w-full items-center'>
                ...
                <div className='py-8 lg:py-10 flex flex-col w-full px-3 lg:w-[50%] absolute'>
                    <div className='text-[#4DD637] text-2xl font-bold flex px-10 py-8'>CONTACT US</div>
                    <div className='flex flex-col items-center gap-5 w-full px-4 md:px-10'>
                        ...
                        <button className='bg-[#4DD637] lg:w-[40%] text-white py-1.5 rounded-full shadow-md hover:shadow-lg duration-300 w-full'>SUBMIT</button>
                    </div>
                </div>
            </div>
        </>

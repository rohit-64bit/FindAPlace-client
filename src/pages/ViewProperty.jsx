                                    ...
                                    return (
                                        <button
                                            ...
                                            className={imageLink === data ?
                                                'xl:w-[80px] lg:w-[80px] w-[65px] sm:w-[75px] md:w-[80px] duration-300 opacity-100' :
                                                'xl:w-[80px] lg:w-[80px] w-[65px] sm:w-[75px] md:w-[80px] duration-300 opacity-50 hover:opacity-100'
                                            }
                                        >

...
const CartComponent = () => {
    return (
        <>
            <div className='flex w-full items-center gap-3 lg:gap-8 py-5'>
                
                <div className='w-[280px] md:w-[350px] lg:w-[260px] xl:w-[200px]'>
                    <img className='rounded-2xl w-[280px] h-[280px] md:w-[250px] md:h-[250px] lg:w-[260px] lg:h-[260px] xl:w-[200px] xl:h-[200px] object-cover shadow-md' src={House} alt="" />
                </div>

                <div className='flex flex-col gap-1 w-[75%]'>

                    <div className='py-1 text-xl md:text-3xl font-bold'>
                        Golf Course
                    </div>
